...
const SECTION_ALIASES: Record<string, SettingsSectionType> = {
  ...
  developer: "system",
  // AKASHML_HIDDEN: account and plansBilling removed as visible sections.
  // Any deep-link to either redirects to general instead.
...
export default function SettingsModal({ open, onOpenChange, initialSection }: SettingsModalProps) {
  ...
  const sidebarItems: SidebarItem<SettingsSectionType>[] = useMemo(
    () => [
      // AKASHML_HIDDEN: Account section removed - users authenticate via AkashML
      // API key directly, no app account needed. Restore by uncommenting:
      // {
      //   id: "account",
      ...
      // AKASHML_HIDDEN: Plans & Billing also removed. Restore by uncommenting:
      // {
      //   id: "plansBilling",
